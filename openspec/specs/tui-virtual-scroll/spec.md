...
The message list SHALL implement virtual scrolling that only renders messages within the visible viewport plus a small buffer. Messages outside the viewport SHALL NOT be rendered.
