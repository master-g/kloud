...
pub fn render(frame: &mut Frame, state: &TuiState, theme: &Theme, show_title_bar: bool) {
...
fn render_transcript(frame: &mut Frame, state: &TuiState, theme: &Theme, show_title_bar: bool) {
	let chunks = if show_title_bar {
